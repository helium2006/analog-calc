'''P沟道增强型MOSFET,输入params字典，包含G,S,D三极电势,Vth,Kn=k*W/L,λ(可选),输出ID'''
...
def enhanced_P_channel_mosfet_without_lambda(params:dict):
    ϕ_S = params['ϕ_S']
    ϕ_G = params['ϕ_G']
    ϕ_D = params['ϕ_D']
    ...
    fet_type = 'enhanced_P_channel_mosfet'
...
def enhanced_P_channel_mosfet_with_lambda(params:dict):
    ϕ_S = params['ϕ_S']
    ϕ_G = params['ϕ_G']
    ϕ_D = params['ϕ_D']
    U_GSth = params['U_GSth']
