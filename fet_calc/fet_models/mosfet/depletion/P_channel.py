'''P沟道耗尽型MOSFET,输入params字典，包含G,S,D三极电势,VGSoff,Kn=k*W/L,λ(可选)'''
...
def depletion_P_channel_mosfet_without_lambda(params:dict):
    ϕ_S = params['ϕ_S']
    ϕ_G = params['ϕ_G']
    ϕ_D = params['ϕ_D']
    ...
    fet_type = 'depletion_P_channel_mosfet'
...
def depletion_P_channel_mosfet_with_lambda(params:dict):
    ϕ_S = params['ϕ_S']
    ϕ_G = params['ϕ_G']
    ϕ_D = params['ϕ_D']
    U_GSoff = params['U_GSoff']
